              ...
              <div className="col-lg-4 col-md-6">
                <div className="card p-5 border-0 rounded-top border-bottom position-relative hover-style-1">
                  ...
                  <p className="mt-3 mb-4">
                    Vestibulum sit amet blan augue, sit amet vehicula mi.
                    Aliquam vitae varius.
                  </p>
                  <a
                    href="about.html"
              ...
              <div className="col-lg-6">
                <div className="pl-3 mt-5 mt-lg-0">
                  <h2 className="mt-1 mb-3">
                    We’ve skill in <br />
                    wide <span className="text-color">
                      range of fitness
                    </span>{" "}
                    and Other body health facility.{" "}
                  </h2>
              ...
              <div className="col-lg-8 col-md-12 col-sm-12">
                <div className="text-center">
                  ...
                  <h2 className="text-lg mt-4 mb-5 text-white">
                    ...
                    <span className="text-color">summer 25% </span>dicsount
                  </h2>
            ...
            <div className="row justify-content-center">
              <div className="col-lg-8 text-center">
                <div className="section-title">
                  ...
                  <h2>Our Services</h2>
                  <p>
                    We offer more than 35 group exercis, aerobic classNamees
                    each week.
                  </p>
                </div>
              </div>
        ...
        <section className="gallery">
          ...
          <div className="container-fluid p-0">
            <div className="row no-gutters portfolio-gallery">
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <a
                  href="images/gallery/gallery-02.jpg"
                  className="popup-gallery"
                >
                  <img
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <a
                  href="images/gallery/gallery-03.jpg"
                  className="popup-gallery"
                >
                  <img
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <a
                  href="images/gallery/gallery-04.jpg"
                  className="popup-gallery"
                >
                  <img
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <a
                  href="images/gallery/gallery-05.jpg"
                  className="popup-gallery"
                >
                  <img
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <a
                  href="images/gallery/gallery-06.jpg"
                  className="popup-gallery"
                >
                  <img
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <a
                  href="images/gallery/gallery-07.jpg"
                  className="popup-gallery"
                >
                  <img
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <a
                  href="images/gallery/gallery-08.jpg"
                  className="popup-gallery"
                >
                  <img
              ...
              <div className="col-lg-8">
                ...
                <div className="testimonial-slider">
                  <div className="text-center mb-4 ">
                    ...
                    <h3 className="mt-4 text-white letter-spacing">
                      A great Start to a healthy life
                    </h3>
                    <p className="my-4 text-white-50">
                      Laboriosam molestias aperiam sit corporis sunt, hic
                      veritatis possimus optio reprehenderit, laudantium
                      excepturi, consequatur. Assumenda hic error veniam
                      exercitationem
                    </p>

                    <div>
                      <h4 className="mb-0 text-capitalize text-white font-weight-normal">
                        John Donas
                      </h4>
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-4 col-md-6 mb-5 mb-lg-0">
                ...
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                  Voluptatibus illo ad quo sunt maiores, sint nostrum omnis
                  eaque cumque dolorum.
                </p>
              ...
              <div className="col-lg-3 col-md-5">
                <div className="footer-widget">
                  ...
                  <p>
                    Washington 6036 Richmond hwy., Alexandria, VA USA 22303{" "}
                  </p>
